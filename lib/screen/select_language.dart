...
class SelectLanguage extends StatefulWidget {
  const SelectLanguage({Key? key,this.isFromProfile=false}) : super(key: key);
                 ...
                 Text(
                   'Select Language',
                    style: Theme.of(context).textTheme.displayLarge?.copyWith(
                        ...
                        ? ColorUtils.kcWhite : ColorUtils.kcBlack,
                        fontSize: 24,
                              ...
                              return Column(
                                ...
                                children: [
                                  selectLanguageButton(
                                    ...
                                    //  var auth  = ApiHandler();
                                      appState.languageKeys =await getKeysLists(appState.currentLanguageCode.value);
