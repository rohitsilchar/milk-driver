...
class FontStyleUtilities {
  ...
  static FontWeight getFontWeight({FWT? fontWeight = FWT.regular}) {
    switch (fontWeight) {
      ...
      case FWT.bold:
        return UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) 
  ...
  static TextStyle h1({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color: isDark.value==true ? fontColor ?? ColorUtils.kcWhite : fontColor ?? ColorUtils.kcTextColor,
  ...
  static TextStyle h4({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color: isDark.value ? fontColor ?? ColorUtils.kcWhite : fontColor ?? ColorUtils.kcTextColor,
      fontWeight: getFontWeight(fontWeight: fontWeight),
      fontSize: 20,
    );
  }
  ...
  static TextStyle h5({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color:isDark.value==true ? fontColor ?? ColorUtils.kcWhite :  fontColor ?? ColorUtils.kcSecondary,
      fontWeight: getFontWeight(fontWeight: fontWeight),
      fontSize: 17,
    );
  }
  ...
  static TextStyle t5({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color:isDark.value==true ? fontColor ?? ColorUtils.kcWhite.withOpacity(0.7) :  fontColor ?? ColorUtils.kcTextColor,
      fontWeight: getFontWeight(fontWeight: fontWeight),
      fontSize: 11,
    );
  }
  ...
  static TextStyle l1({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color : isDark.value==true ? fontColor ?? ColorUtils.kcWhite.withOpacity(0.5) : fontColor ?? ColorUtils.kcTextColor,
      fontWeight: getFontWeight(fontWeight: fontWeight),
      fontSize: 14,
    );
  }
  ...
  static TextStyle p3({
    ...
    return TextStyle(
      fontFamily: UtilsHelper.rightHandLang.contains(appState.currentLanguageCode.value) ? 'TheSans' :'Sands',
      color: isDark.value==true ? fontColor ?? ColorUtils.kcWhite.withOpacity(0.8) : fontColor ?? ColorUtils.kcTextColor,
      fontWeight: getFontWeight(fontWeight: fontWeight),
      fontSize: 12,
    );
  }
